...
You can see examples in the same directory as the docs file, which provides specific example code. The closed-source LGLTracerV3 lib(with t.ds) is in the `examples/tracer` directory.

The examples directory is a multi-page project of node. You can see the examples in the browser after running the command in the directory.
...
The basic example will automatically open in the browser afterwards.:

<div style="width:100%; text-align:center;">
    <img src="_images\Intro\basic.jpg" style="max-width:1200px;" width="100%">
</div>

You can switch the link to see examples:

* http://localhost:8888/basic/index.html
* http://localhost:8888/miniViewer/index.html
...
<div style="width:100%; text-align:center;">
    <img src="_images\Intro\miniViewer.jpg" style="max-width:1200px;" width="100%">
</div>